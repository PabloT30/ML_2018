...
# Importing and preprocessing the data
    # Data - Total of 4928 Images (xxxx for training, yyyy for testing)
...
batch_size = 32
steps = 154     #1000
validation_steps = 14   #300
filtersConv1 = 32
filtersConv2 = 64
filtersConv3 = 128
size_filter1 = (3, 3) #(3,3)
size_filter2 = (2, 2) #(2,2)
size_filter3 = (1,1)
tamano_pool = (2, 2)
classes = 2
lr = 0.04 #0.0004 funciona bien #recomiendan usar 0.001
#Keras: lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-08, decay=0.0.

training_path = 'datav2/elbow_dataset'
validation_path = 'data/elbow_validation'
test_path = 'data/elbow_test'
...
cnn.add(Convolution2D(filtersConv3, size_filter3, padding ="same"))
cnn.add(MaxPooling2D(pool_size=tamano_pool))
...
cnn.fit_generator(          #see what happens with verbose
    train_generator,
